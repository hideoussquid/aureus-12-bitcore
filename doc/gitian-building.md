...
*Setup instructions for a Gitian build of Aureus using a Debian VM or physical system.*
...
- [Building Aureus](#building-aureus)
...
in the aureus repository under 'Fetch and build inputs' to install sources which require
...
To build Aureus (for Linux, OS X and Windows) just follow the steps under 'perform
...
AURPATH=/some/root/path/aureus.git
SIGPATH=/some/root/path/aureus-detached-sigs.git
...
[aureus/gitian.sigs](https://github.com/aureus/gitian.sigs/) repository, or if that's not possible create a pull
